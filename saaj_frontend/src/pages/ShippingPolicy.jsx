  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-rose-50/50 via-amber-50/30 to-rose-50/50 py-12 px-4 sm:px-6">
      <SEO
        ...
        description="SAAJJEWELS shipping information — delivery timelines, shipping charges, and pan-India delivery details."
        url="/shipping-policy"
      />
            ...
            <ul className="list-disc pl-8 text-gray-700 mb-6 space-y-2">
              <li>
                {!shippingEnabled || shippingCost === 0
                  ...
                  : `A flat fee of ₹${shippingCost ?? 69} is applied to all orders.`}
              </li>
              {shippingEnabled && shippingCost > 0 && (
