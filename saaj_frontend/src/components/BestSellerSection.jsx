  ...
  useEffect(() => {
    const fetchProducts = async () => {
      ...
      try {
        ...
        // Derive image from media array for each product
        const processed = Array.isArray(data) ? data.map(product => {
        ...
        >
          <div className="relative">
            <div className="aspect-square overflow-hidden">
              <img
                src={product.image}
                alt={`${product.name} - ${product.category || "Jewellery"} by SAAJJEWELS`}
                loading="lazy"
